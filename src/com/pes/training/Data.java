...
public class Data {
	...
	public static final String KEY_YEAR="Sem";
	public static final String KEY_PER="CGPA";
	
	private static final String DATABASE_NAME="Datadb";
	private static final String DATABASE_TABLE="train";
	...
	public long createEntry(String name, String detail,String date,
			String location, String Sem,String CGPA) {
		// TODO Auto-generated method stub
	...
	public String getData3(String s2, String s3) {
		// TODO Auto-generated method stub
		String[] columns=new String[]{KEY_NAME,KEY_DETAIL,KEY_DATE,KEY_LOCATION};
		String query="SELECT * FROM train WHERE CGPA="+"'"+s3+"' AND Sem="+"'"+s2+"'";
		Cursor c=ourDatabase.rawQuery(query, null);
		//Cursor c=ourDatabase.query(DATABASE_TABLE, columns, KEY_PER +"=" +s3,null,null,null,null);
		String result="";
		int iName=c.getColumnIndex(KEY_NAME);
		int iDETAIL=c.getColumnIndex(KEY_DETAIL);
		int iDATE=c.getColumnIndex(KEY_DATE);
